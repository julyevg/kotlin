...
*/
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(session!="none") {
            ...
            editar.setOnClickListener { view ->
                ...
                intento.putExtra(Usuario.KEY_USUARIO, users.nombre)
                intento.putExtra(Usuario.KEY_PASSWORD, users.password)
                intento.putExtra(Usuario.KEY_NAME, users.nombre)
                intento.putExtra(Usuario.KEY_LASTNAME, users.lastname)
                intento.putExtra(Usuario.KEY_DNI, users.dni)
                intento.putExtra(Usuario.KEY_ADDRESS, users.address)
 ...
 /*   private fun createUser() :User? {
        ...
        users = sessionObj.getString(Usuario.KEY_USUARIO)
        password = sessionObj.getString(Usuario.KEY_PASSWORD)
        nombre = sessionObj.getString(Usuario.KEY_NAME)
        lastname = sessionObj.getString(Usuario.KEY_LASTNAME)
        dni = sessionObj.getString(Usuario.KEY_DNI)
        address = sessionObj.getString(Usuario.KEY_ADDRESS)
